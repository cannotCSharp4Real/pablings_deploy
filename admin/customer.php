    ...
    <div class="container">
        <div class="menu">
            ...
            <nav class="menu-links" style="margin-top: 30px;">
                ...
                <a href="customer.php" class="non-style-link-menu non-style-link-menu-active"><div class="menu-btn menu-icon-customer menu-active menu-icon-customer-active"><p class="menu-text">Customer</p></div></a>
            </nav>
        </div>
        <div class="dash-body">
