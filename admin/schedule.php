    ...
    <div class="container">
        <div class="menu">
            ...
            <nav class="menu-links" style="margin-top: 30px;">
                ...
                <a href="barber.php" class="non-style-link-menu"><div class="menu-btn menu-icon-barber"><p class="menu-text">Barber</p></div></a>
                <a href="schedule.php" class="non-style-link-menu non-style-link-menu-active"><div class="menu-btn menu-icon-schedule menu-active menu-icon-schedule-active"><p class="menu-text">Schedule</p></div></a>
