                ...
                <tr >
                    ...
                    <td>
                        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                            <a href="schedule.php"><button type="button" class="btn-primary" style="min-width: 110px;">&larr; Back</button></a>
                            ...
                            <table class="sub-table scrolldown" style="width: 100%; border-collapse: separate; border-spacing: 0;">
                                <thead>
                                    <tr style="border-bottom: 2px solid #1976d2;">
                                        ...
                                        <th class="table-headin" style="font-size: 16px; font-weight: 600; padding: 12px 8px;">Sheduled Date & Time</th>
                                        <th class="table-headin" style="font-size: 16px; font-weight: 600; padding: 12px 8px;">Max num that can be booked</th>
                                                ...
                                                <?php
                                                    ...
                                                    if($result->rowCount()==0){
                                                        ...
                                                        for ($x=0; $x<$result->rowCount(); $x++) {
                                                            ...
                                                            echo '<a href="?action=view&id='.$scheduleid.'" class="non-style-link"><button class="btn-primary">View</button></a>';
                                                            echo '<a href="?action=drop&id='.$scheduleid.'&name='.$title.'" class="non-style-link"><button class="btn-primary">Remove</button></a>';
                                                            echo '</div>';
                                                            echo '</td>';
                                                            echo '</tr>';
                                                        }
