...
<body>
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;color:var(--textcolor);" >
                <tr >
                    <td width="13%" >
                    <a href="index.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button>
                    </a>
                    </td>
                    <td>
                        <p style="font-size: 25px;padding-left:12px;font-weight: 600;margin-left:12px;">Barber</p>
                                           
                    </td>
                    <td width="15%">
                        <p style="font-size: 14px;color:rgb(74, 71, 71);font-weight: 600;text-align: center;">
                            Today's Date
                        </p>
                        <p class="heading-sub12" style="font-size: 20px;font-weight: bold;text-align: center;">
                            <?php 
                    ...
                    <td width="5%">
                    <div class="btn-user" style="margin-left:0px;">
                    </div>
                    </td>
                </tr>
