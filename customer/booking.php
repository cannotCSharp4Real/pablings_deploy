                ...
                <tr>
                    <td colspan="4">
                        ...
                        if(isset($_GET["id"])){
                                ...
                                <div class="booking-container">
                                    <div class="session-details">
                                        ...
                                        <div style="font-size: 18px; line-height: 30px;">
                                            <p><strong>Barber name:</strong> <?php echo htmlspecialchars($docname); ?></p>
                                            <p><strong>Barber Email:</strong> <?php echo htmlspecialchars($docemail); ?></p>
                                            <p><strong>Session Title:</strong> <?php echo htmlspecialchars($title); ?></p>
                                            <p><strong>Session Scheduled Date:</strong> <?php echo htmlspecialchars($scheduledate); ?></p>
                                            <p><strong>Session Starts:</strong> <?php echo htmlspecialchars($scheduletime); ?></p>
                            ...
                            echo '<div style="text-align: center; padding: 40px 0;">
                                <p style="font-size: 18px; color: #666;">No session ID provided.</p>
                                <a href="schedule.php" class="non-style-link">
                                    <button class="login-btn btn-primary-soft btn" style="margin-top: 16px;">Back to Sessions</button>
                                </a>
                            </div>';
